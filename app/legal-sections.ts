...
export const legalMeta: Record<Lang, Record<LegalSection, { label: string; description: string }>> = {
  zh: {
    imprint: { label: "法律声明", description: "Jiashan Frankonia EMC Co., Ltd. 网站运营信息、企业登记及备案信息。" },
    privacy: { label: "隐私政策", description: "嘉善网站的个人信息处理说明：访问日志、询价、本地存储、境外接收方及个人信息权利。" },
  },
  en: {
    imprint: { label: "Imprint", description: "Website operator, company registration and filing information for Jiashan Frankonia EMC Co., Ltd." },
